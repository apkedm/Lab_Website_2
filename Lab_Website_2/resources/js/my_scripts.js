...
function loadStatsPage() {
	...
	for(i = 2; i < document.getElementById("stats_table").rows.length; i++) {
		var cu_score = parseInt(document.getElementById("stats_table").rows[i].cells[2].innerHTML);
		var opponent_score = parseInt(document.getElementById("stats_table").rows[i].cells[3].innerHTML);
		if(cu_score > opponent_score) {
			document.getElementById("stats_table").rows[i].cells[4].innerHTML = "CU Boulder";
			wins++;
		}
		else if(cu_score < opponent_score) {
